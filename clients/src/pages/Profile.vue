    ...
    <div class="row">
      <div class="col">
        ...
        <q-card-section>
          ...
          <q-input :readonly="cantEdit" v-model="name" hint="Имя пользователя" @blur="changeName()">
            <template v-slot:append>
              <q-icon :name="'edit'" class="cursor-pointer" @click="cantEdit = !cantEdit">
              </q-icon>
            </template>
          </q-input>
      ...
      <div class="col">
        ...
        <q-card-section>
          ...
          <q-input v-model="password" :type="isPwd ? 'password' : 'text'" label="Новый пароль">
            <template v-slot:append>
        ...
        <q-card-section>
          <q-input v-model="password_again" :type="isPwd ? 'password' : 'text'" label="Подтвержение пароля" />
        </q-card-section>

        <q-card-section>
          <q-btn flat class="button" label="Изменить пароль" @click="changeUserPass"></q-btn>
        </q-card-section>
      </div>
    </div>
